#### pre-store data
```
[root@node74 ~]# fio -direct=1 -ioengine=rbd -group_reporting -name=vol_base_test -bs=256K -iodepth 1 -numjobs 1 -size=1G -rw=write -pool=.disk01.rbd -rbdname=vol0
...
Disk stats (read/write):
    dm-0: ios=0/464, merge=0/0, ticks=0/213, in_queue=213, util=0.38%, aggrios=0/1091, aggrmerge=0/18, aggrticks=0/12747, aggrin_queue=12746, aggrutil=1.11%
