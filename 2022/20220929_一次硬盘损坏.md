...
```
// 底层库libaio返回报错-5
2022-09-27 08:07:37.995853 7f16d59f1700 2393758 14 ERROR -1 scache io error, comp_type = 7, data = 0x7f15e3d95848, success = 0, comp_len = -5
2022-09-27 08:07:37.995894 7f16d51f0700 2393759 18 ERROR -1 bluestore(/var/lib/ceph/osd/ceph-18) on_read_queue_ex_on_complete->result = -5 
```

```
[Tue Sep 27 08:07:43 2022] sd 0:2:27:0: [sdab] tag#1226 FAILED Result: hostbyte=DID_BAD_TARGET driverbyte=DRIVER_OK cmd_age=26s
[Tue Sep 27 08:07:43 2022] sd 0:2:27:0: [sdab] tag#1226 CDB: Read(16) 88 00 00 00 00 02 91 89 d6 00 00 00 00 80 00 00
[Tue Sep 27 08:07:43 2022] blk_update_request: I/O error, dev sdab, sector 11031664128 op 0x0:(READ) flags 0x0 phys_seg 16 prio class 0 
```
